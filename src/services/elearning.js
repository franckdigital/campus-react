...
export const elearningService = {
  ...
  startExamSession: (examId, deviceToken) => api.post(`/elearning/exams/${examId}/start-session/`, { device_token: deviceToken }),
  heartbeatExamSession: (examId, deviceToken) => api.post(`/elearning/exams/${examId}/heartbeat/`, { device_token: deviceToken }),
  ...
  getExamAbsencesOverview: (params = {}) => {
    const q = new URLSearchParams(Object.entries(params).filter(([, v]) => v !== undefined && v !== null && v !== '')).toString();
